...
class six_word_simulator:
    ...
    def read(self, addr):
        ...
        self.log.append(f"'{self.console_memory}' was read from keyboard into address: {str(addr).zfill(3)}") #Logs the operation.
    ...
    def write(self, addr):
        ...
        self.log.append(f"{self.console_memory} was written to screen from address: {str(addr).zfill(3)}") #Logs the operation.
        return True
    ...
    def load(self, addr):
        ...
        self.log.append(f"{word} was loaded to the accumulator from address: {str(addr).zfill(3)}") #Logs the operation.
    ...
    def store(self, addr):
        ...
        self.log.append(f"{self.accumulator} was stored from the accumulator into address: {str(addr).zfill(3)}") #Logs the operation.
    ...
    def add(self, addr):
        ...
        self.log.append(f"{intial_acc} from the accumulator was added to {self.registers[int(addr)]} from address: {str(addr).zfill(3)} and result ({self.accumulator}) was stored back in the accumulator")
        return True
    ...
    def subtract(self, addr):
        ...
        #The following elif and else statements format the result to be stored in the accumulator.
            ...
            self.accumulator = f"{str(result).zfill(6)}"#changing this to be a 6, lets see what happens
        #It's a long log entry, but is usefull to see what happened.
        self.log.append(f"{intial_acc} from the accumulator was subtracted by {self.registers[int(addr)]} from address: {str(addr).zfill(3)} and result ({self.accumulator}) was stored back in the accumulator")
        return True
    ...
    def divide(self, addr):
        ...
        #The following elif and else statements format the result to be stored in the accumulator.
            ...
            self.accumulator = f"{str(result).zfill(6)}"#changing this to be a 6, lets see what happens
        #It's a long log entry, but is usefull to see what happened.
        self.log.append(f"{intial_acc} from the accumulator was divided by {self.registers[int(addr)]} from address: {str(addr).zfill(3)} and result ({self.accumulator}) was stored back in the accumulator")
        return True
    ...
    def branch(self, addr):
        ...
        self.log.append(f"Program branched to address: {str(addr).zfill(3)}") #Logs the operation
        return True
    ...
    def branch_neg(self, addr):
        ...
        if int(int(self.accumulator)) < 0:
            self.cur_addr = int(addr) - 1
            self.log.append(f"Program branched to address: {str(addr).zfill(3)} since the accumulator was negative({self.accumulator})") #Logs the operation
        return True
    ...
    def branch_zero(self, addr):
        ...
        if self.accumulator == "+000000":
            self.cur_addr = int(addr) - 1
            self.log.append(f"Program branched to address: {str(addr).zfill(3)} since the accumulator was zero({self.accumulator})") #Logs the operation
        return True
